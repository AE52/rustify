...
export type AwsRegion = Schemas['AwsRegionDto']
export type AwsInstanceType = Schemas['AwsInstanceTypeDto']
export type AwsProvision = Schemas['AwsProvision']
export type AwsProvisionResponse = Schemas['AwsProvisionResponse']
export type AwsServer = Schemas['AwsServerDto']
